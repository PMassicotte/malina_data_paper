...
\begin{figure}[H]
	...
	\caption{(\textbf{A}) Latitudinal cross-sections of bacterial abundance measured from flow cytometry (gray dots) in transects 600 and 300. Station numbers are identified in light gray on top of each panel. (\textbf{B}) xxxx}
\end{figure}
