...
\begin{figure}[H]
	...
	\caption{(\textbf{A}) Latitudinal cross-sections of bacterial abundance measured from flow cytometry (gray dots) in transects 600 and 300. Station numbers are identified in light gray on top of each panel. (\textbf{B}) Cumulative bar charts comparing the relative class abundances in particle-attached (PA) and free-living (FL) for a selected number of samples.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{(\textbf{A}) CO and CO$_2$ production measured at 280 and 295 nm at surface for stations of transects 600 and 300 (bold numbers on the right of the graph). (\textbf{B}) Autoxidation of suspended particulate material for stations of transects 600 and 300.}
\end{figure}
