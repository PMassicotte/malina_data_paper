...
\begin{figure}[H]
	...
	\caption{Geolocalisations of the sampling sites.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Temperature and salinity. Black dots are measured data from the CTD.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{NO3 and PO4. Black dots are measured data from the niskin bottles.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Placeholder for the CDOM figure.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[]{example-image-a}
	\caption{Placeholder for the bacteiral abundance figure.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[]{example-image-a}
	\caption{Placeholder for the primary production figure.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{CO$_2$ production at surface for stations in transects 300 and 600. Stations are identified on top of each panel.}
\end{figure}
