...
\begin{figure}[H]
	...
	\caption{Daily discharge of the Mackenzie river at the Arctic Red River junction (station 10LC014). The colored segment identifies the period of the Malina campaign. Discharge data from Government of Canada (https://wateroffice.ec.gc.ca/search/historical\_e.html).}
\end{figure}
