...
\Author[14]{Flavienne}{Bruyant}
\Author[15]{Gwenaëlle}{Chaillou}
\Author[16]{Malik}{Chami}
\Author[17]{Bruno}{Charrière}
\Author[18]{Jingan}{Chen}
\Author[5]{Hervé}{Claustre}
\Author[1]{Pierre}{Coupel}
\Author[17]{Nicole}{Delsaut}
\Author[19]{David}{Doxaran}
\Author[20]{Jens}{Ehn}
\Author[21]{Cédric}{Fichot}
\Author[1]{Marie-Hélène}{Forget}
\Author[22]{Pingqing}{Fu}
\Author[1]{Jonathan}{Gagnon}
\Author[23]{Nicole}{Garcia}
\Author[24]{Beat}{Gasser}
\Author[25]{Jean-François}{Ghiglione}
\Author[26]{Jacques}{Giraudeau}
\Author[20]{Gaby}{Gorsky}
\Author[27]{Michel}{Gosselin}
\Author[28]{Priscillia}{Gourvil}
\Author[29]{Yves}{Gratton}
\Author[30]{Pascal}{Guillot}
\Author[20]{Song}{Guisheng}
\Author[31]{Hermann J.}{Heipieper}
\Author[17]{Serge}{Heussner}
\Author[20]{Stan}{Hooker}
\Author[20]{Yannick}{Huot}
\Author[32]{Violaine}{Jacq}
\Author[7]{Christian}{Jeanthon}
\Author[33]{Wade}{Jeffrey}
\Author[20]{Fabien}{Joux}
\Author[34]{Kimitaka}{Kawamura}
\Author[35]{Bruno}{Lansard}
\Author[5]{Edouard}{Leymarie}
\Author[36]{Heike}{Link}
\Author[20]{Connie}{Lovejoy}
\Author[20]{Claudie}{Marec}
\Author[7]{Dominique}{Marie}
\Author[20]{Johannie}{Martin}
\Author[1,37]{Guillaume}{Massé}
\Author[1]{Atsushi}{Matsuoka}
\Author[20]{Alexandre}{Mignot}
\Author[38]{William L.}{Miller}
\Author[20]{Juan-Carlos}{Miquel}
\Author[20]{Alfonso}{Mucci}
\Author[39]{Kaori}{Ono}
\Author[20]{Eva}{Ortega}
\Author[23]{Christos}{Panagiotopoulos}
\Author[20]{Tim}{Papakyriakou}
\Author[20]{Julien}{Para}
\Author[5]{Marc}{Picheral}
\Author[40,41]{Dieter}{Piepenburg}
\Author[42]{Louis}{Prieur}
\Author[23]{Patrick}{Raimbault}
\Author[5]{Joséphine}{Ras}
\Author[43]{Rick A.}{Reynolds}
\Author[27]{André}{Rochon}
\Author[23]{Jean-François}{Rontani}
\Author[44]{Catherine}{Schmechtig}
\Author[26]{Sabine}{Schmidt}
\Author[23]{Richard}{Sempéré}
\Author[11,45]{Yuan}{Shen}
\Author[20]{Nathalie}{Simon}
\Author[46,47]{Guishen}{Song}
\Author[43]{Dariusz}{Stramski}
\Author[20]{Dave}{Stroud}
\Author[39]{Eri}{Tachibana}
\Author[20]{Alexandre}{Thirouard}
\Author[24]{Imma}{Tolosa}
\Author[1]{Jean-Éric}{Tremblay}
\Author[48]{Mickael}{Vaïtilingom}
\Author[7,49]{Daniel}{Vaulot}
\Author[23]{Frédéric}{Vaultier}
\Author[50]{John K.}{Volkman}
\Author[51]{Jorien E.}{Vonk}
\Author[20]{Vanessa}{Wright/McKague}
\Author[46]{Huixiang}{Xie}
\Author[43,52,53]{Guangming}{Zheng}
...
\affil[14]{UMI Takuvik, CNRS/Université Laval, Québec, QC, Canada}
\affil[15]{Quebec Océan, Institut des Sciences de la mer de Rimouski, Université du Québec à Rimouski, 310 allée des Ursulines, Rimouski, Qc, G5L 3A1}
\affil[16]{Sorbonne Université, CNRS-INSU, Laboratoire Atmosphères Milieux Observations Spatiales (LATMOS), Boulevard de l’Observatoire, CS 34229, 06304 Nice Cedex, France}
\affil[17]{Centre de Formation et de Recherche sur les Environnements Méditerranéens (CEFREM, UMR CNRS UPVD 5110), 52 Avenue Paul Alduy, 66860 Perpignan Cedex, France}
\affil[18]{SKLEG, Institute of Geochemistry, Chinese Academy of Sciences, 99 West Lincheng Road, Guiyang, Guizhou 550081, P.R. China}
\affil[19]{Laboratoire d'Océanographie de Villefranche UMR7093 CNRS/SU, F-06230, Villefranche-sur-Mer, France}
\affil[20]{unidentified}
\affil[21]{Department of Earth and Environment, Boston University, Boston, Massachusetts, 02215, USA}
\affil[22]{Institute of Surface-Earth System Science, Tianjin University, Tianjin, China}
\affil[23]{Aix Marseille Univ, Université de Toulon, CNRS, IRD, Mediterranean Institute of Oceanography (MIO) UM 110, Marseille, France, 13288, Marseille, France.}
\affil[24]{International Atomic Energy Agency-Environment Laboratories, 4, quai Antoine 1er, MC 9800 MONACO}
\affil[25]{CNRS, Sorbonne Universités, UMR 7621, Laboratoire d’Océanographie Microbienne, Observatoire Océanologique de Banyuls, France}
\affil[26]{Univ. Bordeaux, CNRS, EPOC, EPHE, UMR 5805, F-33600 Pessac, France}
\affil[27]{Institut des sciences de la mer de Rimouski, Université du Québec à Rimouski, 310 allée des Ursulines, Rimouski, QC, Canada}
\affil[28]{FR2424, CNRS/Sorbonne Université, Station Biologique, 29680 Roscoff, France}
\affil[29]{INRS-ETE, Québec, Qc, Canada}
\affil[30]{Institut des sciences de la mer de Rimouski, Université du Québec à Rimouski, Rimouski, Qc, Canada}
\affil[31]{Department of Environmental Biotechnology Permoserstraße 15 D-04318 Leipzig, Germany}
\affil[32]{JE SAIS PAS CE QU ELLE EST DEVENUE}
\affil[33]{Center for Environmental Diagnostics \& Bioremediation, Universty of West Florida, 11000 University Parkway, Pensacola, FL 32514 USA}
\affil[34]{Chubu Institute for Advanced Studies, Chubu University, Kasugai, Japan}
\affil[35]{Laboratoire des Sciences du Climat et de l’Environnement, UMR 8212 CEA-CNRS-UVSQ, IPSL and Université Paris-Saclay, CEA-Orme des Merisiers, Bat 714, 91190 Gif-sur-Yvette, France}
\affil[36]{Department Maritime Systems, University of Rostock, 18059 Rostock, Germany}
\affil[37]{UMR Locean, CNRS/Sorbonne Université/MNHN/IRD, Concarneau, France}
\affil[38]{Department of Marine Sciences, 325 Sanford Drive, University of Georgia, Athens, GA 30602}
...
\affil[42]{CNRS, LOV, F-06230 Villefranche-sur-Mer, France}
...
\affil[44]{OSU Ecce Terra - UMS 3455 Sorbonne Université 4, Place Jussieu 75 252 Paris Cedex 05, France}
\affil[45]{State Key Laboratory of Marine Environmental Science, College of Ocean and Earth Sciences, Xiamen University, Xiamen, Fujian, P. R. China}
\affil[46]{Institut des sciences de la mer de Rimouski, Université du Québec à Rimouski, Rimouski, Québec, Canada}
\affil[47]{School of Marine Science and Technology, Tianjin University, Tianjin, 300072, China}
\affil[48]{Université des Antilles Pointe-à-Pitre, Guadeloupe, France}
...
\affil[52]{NOAA/NESDIS Center for Satellite Applications and Research, 5830 University Research Court, College Park, MD 20740, U.S.A.}
\affil[53]{Earth System Science Interdisciplinary Center, University of Maryland Research Park, 5825 University Research Court, College Park, MD 20740, U.S.A.}
